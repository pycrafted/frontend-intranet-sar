      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-900">{pagination.total}</p>
              </div>
        ...
        <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-blue-700">Directions</p>
                <p className="text-2xl font-bold text-blue-900">{directions.length}</p>
              </div>
        ...
        <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-green-700">Managers</p>
                <p className="text-2xl font-bold text-green-900">{managers.length}</p>
              </div>
        ...
        <Card className="bg-gradient-to-r from-purple-50 to-violet-50 border-purple-200">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-purple-700">Sélectionnés</p>
                <p className="text-2xl font-bold text-purple-900">{Array.isArray(selectedAgents) ? selectedAgents.length : 0}</p>
              </div>
            ...
            <div className="flex-1 relative">
              ...
              <Input
                ...
                className={`pl-10 border-orange-200 focus:border-orange-400 ${
                  searchFocused ? 'ring-2 ring-orange-200' : ''
                }`}
              />
              {isTyping && (
          ...
          {showFilters && (
            <div className="mt-4 p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg border border-orange-200">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <label className="text-sm font-medium text-gray-700 mb-2 block">Taille de page</label>
                  <Select
                    value={filters.page_size.toString()}
                    onValueChange={(value) => setFilters({ page_size: parseInt(value) })}
                  >
                    <SelectTrigger className="border-orange-200">
                      <SelectValue />
                    </SelectTrigger>
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmitForm} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="text-sm font-medium mb-2 block text-gray-700">Manager</label>
                <Select
