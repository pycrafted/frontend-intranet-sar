...
export function ImageDebugger({ imageUrl, articleId, articleTitle }: ImageDebuggerProps) {
    ...
    <Card className="w-full">
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="text-lg">🔍 Diagnostic d'Image</CardTitle>
          <Button 
            onClick={runTests} 
            disabled={isRunning}
            size="sm"
        ...
        <div className="space-y-2">
          <p className="text-sm text-gray-600">
            <strong>Article:</strong> {articleTitle} (ID: {articleId})
          </p>
