      ...
      <div className="flex h-12 xs:h-14 sm:h-16 items-center justify-between px-2 xs:px-3 sm:px-4 lg:px-6 navbar-mobile-optimized">
        ...
        <div className="flex items-center gap-1 xs:gap-1.5 sm:gap-2 flex-shrink-0">
          ...
          <Button variant="ghost" size="sm" className="relative text-navbar-foreground hover:bg-navbar-foreground/10 flex-shrink-0 h-7 w-7 xs:h-8 xs:w-8 sm:h-10 sm:w-10 p-0">
            ...
            <Badge className="absolute -top-0.5 -right-0.5 xs:-top-1 xs:-right-1 h-2.5 w-2.5 xs:h-3 xs:w-3 sm:h-4 sm:w-4 lg:h-5 lg:w-5 rounded-full p-0 text-xs bg-destructive text-destructive-foreground flex items-center justify-center">
              3
            </Badge>
          </Button>
          ...
          {isAuthenticated && user ? (
            ...
            <Button
              ...
              className="text-navbar-foreground hover:bg-navbar-foreground/10 h-7 xs:h-8 sm:h-10 px-1.5 xs:px-2 sm:px-3 text-xs sm:text-sm"
            >
              <User className="h-3 w-3 xs:h-3.5 xs:w-3.5 sm:h-4 sm:w-4 mr-1 xs:mr-1.5 sm:mr-2" />
