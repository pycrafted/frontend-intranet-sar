...
import { TrainingModal } from '@/components/sirh/training/TrainingModal'
    ...
    <AuthGuard>
      <LayoutWrapper>
        <div className="w-full max-w-4xl mx-auto space-y-6 overflow-hidden">
          ...
          {modal && (
            <TrainingModal
              trainingNames={sirh.trainingNames}
              trainingSources={sirh.trainingSources}
              trainingActionTypes={sirh.trainingActionTypes}
              onClose={() => setModal(false)}
              onSubmit={sirh.createTrainingRequest}
            />
          )}
        </div>
      </LayoutWrapper>
