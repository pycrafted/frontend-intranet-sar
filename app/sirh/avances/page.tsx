...
import { AdvanceList } from '@/components/sirh/advances/AdvanceList'
import { AdvanceModal } from '@/components/sirh/advances/AdvanceModal'
      ...
      <LayoutWrapper>
        <div className="w-full max-w-4xl mx-auto space-y-6 overflow-hidden">
          ...
          {sirh.loading ? (
            ...
            <AdvanceList advances={sirh.advances} advanceTypes={sirh.advanceTypes} onNew={() => setModal(true)} />
          )}

          {modal && (
            <AdvanceModal advanceTypes={sirh.advanceTypes} onClose={() => setModal(false)} onSubmit={sirh.createAdvance} />
          )}
        </div>
      </LayoutWrapper>
    </AuthGuard>
